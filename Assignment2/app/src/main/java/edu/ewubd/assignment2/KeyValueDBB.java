...
public class KeyValueDBB extends SQLiteOpenHelper {

    // TABLE INFORMATTION
    static final String DB_NAME = "KEYDB.DB";
    public final String TABLE_KEY_VALUE = "key_values";
    public final String KEY = "keyy";
    public final String VALUE = "item";
    //
    public KeyValueDBB(Context context) {
